	...
	Partial Public Class Form1
		...
		Public Class AddInFunction
			...
			Private Function ConvertArrayParameter(ByVal parameter(,) As DevExpress.Spreadsheet.CellValue) As Object(,)
				...
				Dim result(,) As Object = CType(Array.CreateInstance(GetType(Object), New Integer() { height, width }, New Integer() { 1, 1 }), Object(,))
            ...
            Private Function ConvertResultValueCore(ByVal value As Object) As DevExpress.Spreadsheet.CellValue
                ...
                If TypeOf value Is Integer Then
                    If ErrorToValueDictonary.ContainsKey(CType(value, Integer)) Then
                        Return ErrorToValueDictonary(CType(value, Integer))
                    Else
                        Return DevExpress.Spreadsheet.CellValue.FromObject(value)
                    End If
                End If
                Return DevExpress.Spreadsheet.CellValue.FromObject(value)
            End Function
